...
export interface MicrophoneButtonHandle {
  stop: () => void
}
...
export const MicrophoneButton = forwardRef<MicrophoneButtonHandle, MicrophoneButtonProps>(
  function MicrophoneButton(
    { language: initialLanguage, onLanguageChange, onTranscriptChange, disabled },
    ref
  ) {
    ...
    // Single source of truth for speech-to-text state
