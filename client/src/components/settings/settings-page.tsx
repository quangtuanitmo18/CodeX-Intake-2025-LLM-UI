      ...
      <main className="mx-auto max-w-4xl px-4 py-6 md:py-8">
        ...
        <div className="space-y-4 md:space-y-6">
          ...
          <div className="rounded-lg border border-gray-800 bg-gray-900/50 p-4 md:p-6">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                ...
                <select className="min-h-[44px] w-full rounded-lg border border-gray-700 bg-gray-800 px-3 py-2 text-sm outline-none transition focus:border-blue-500 md:w-auto md:px-4">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                ...
                <input
                  ...
                  step="0.1"
                  defaultValue="0.7"
                  className="min-h-[44px] w-full rounded-lg border border-gray-700 bg-gray-800 px-3 py-2 text-sm outline-none transition focus:border-blue-500 md:w-24 md:px-4"
                />
              </div>
          ...
          <div className="rounded-lg border border-gray-800 bg-gray-900/50 p-4 md:p-6">
            ...
            <div className="space-y-3 md:space-y-4">
              <label className="flex min-h-[44px] items-center justify-between gap-4 md:min-h-0">
                <div className="flex-1">
                ...
                <input
                  type="checkbox"
                  defaultChecked
                  className="h-5 min-h-[44px] w-5 min-w-[44px] shrink-0 rounded border-gray-700 bg-gray-800 text-blue-600 focus:ring-2 focus:ring-blue-500 md:min-h-0 md:min-w-0"
                />
              </label>
          ...
          <div className="rounded-lg border border-red-900/50 bg-red-900/10 p-4 md:p-6">
            ...
            <div className="space-y-3 md:space-y-4">
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <button className="min-h-[44px] w-full rounded-lg border border-red-700 bg-red-900/50 px-4 py-2 text-sm font-medium text-red-500 transition hover:bg-red-900 active:bg-red-900/80 md:min-h-0 md:w-auto">
                  Delete All
                </button>
              </div>
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                ...
                <button className="min-h-[44px] w-full rounded-lg bg-red-600 px-4 py-2 text-sm font-medium transition hover:bg-red-700 active:bg-red-800 md:min-h-0 md:w-auto">
                  Delete Account
                </button>
              </div>
            </div>
