...
// Static page - no need for client-side rendering
      ...
      <main id="main-content" className="mx-auto flex w-full max-w-4xl flex-col gap-10 px-4 py-16">
        ...
        <section className="space-y-5 rounded-3xl border border-white/10 bg-white/5 p-6 text-base leading-relaxed shadow-inner backdrop-blur lg:p-8">
          ...
          <p>
            ...
            технологические сферы и продукты. Мы предлагаем вам поработать на передовой —
            попробовать создать собственный интерфейс для взаимодействия с моделью. Это
            увлекательная задача, которая позволит разобраться в принципах работы интерфейсов для
            LLM, попрактиковаться в работе со стримами, парсингом Markdown, анимациями и рендерингом
            различных блоков. Надеемся, что в процессе выполнения задания вы узнаете что-то новое и
            получите полезный опыт.
          </p>
